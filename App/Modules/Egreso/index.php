<?php 
    ...
    */
    ...
    $Data=Table::getListQuery("select * from movimientos where TIPOREGISTRO='S' ".$condicion." and TIPOCONCEPTO='".$_GET['TP']."' ORDER BY NRORECIBOEGRESO DESC");
?>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-personal">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=str_pad($value['NRORECIBOEGRESO'],7,'0',STR_PAD_LEFT)?></td>
                                       ...
                                       <?php
                                        ...
                                        ?>
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm"  data-toggle=  "modal" data-target="#dataUpdate"
                                                ...
                                                data-acuenta='<?=$value['MONTOBS']?>'
                                                data-saldo='<?=$value['SALDO']?>'
                                                data-totalbs='<?=$value['TOTALBS']?>'
                                                data-nombredestino='<?=$value['NOMBREDESTINO']?>'
                                                ...
                                                data-nroreciboegreso='<?=$value['NRORECIBOEGRESO']?>'
                                           ...
                                           <?php
                                            ...
                                            <!--<button type="button" class="btn btn-success btn-sm" data-toggle="modal"  data-id="<?=$value['IDMOVIMIENTO']?>"  >Cargar Dep.
                                           </button>-->
                                            </div>  
                                        </td>
