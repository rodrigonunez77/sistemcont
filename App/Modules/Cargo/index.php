...
<head>
    ...
    <?php
       include 'newCargo.php';
       include 'editCargo.php';
       include 'delCargo.php';
    ?>
</head>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-cargo">
                                <thead>
                                    <tr>
                                        <th>Nro</th>
                                        <th>Fecha</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" style="width: 50px">
                                              ...
                                              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#dataDelete" data-id="<?=$value['IDCARGO']?>"  >
