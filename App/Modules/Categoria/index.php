                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-categoria">
                                ...
                                <tbody>
                                    ...
                                    foreach ($DataC as $key => $value){
                                            $DataL=Table::getListQuery("select * from logs where CODIGOUNICO='".$value['CODIGOUNICO']."'  ORDER BY IDLOG DESC");
                                    ?>
                                    <tr>
                                        <td><?=$key+1 ?></td>
                                        <td><?=$DataL[0]['FECHASISTEMA']?></td> 
                                        ...
                                        <td>
                                            <div class="btn-group" style="width: 50px">
                                              ...
                                              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#dataDelete" data-id="<?=$value['IDCATEGORIA']?>"  >
