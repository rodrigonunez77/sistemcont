	...
	<div class="modal-dialog modal-lg" id="ModalCompraSIZE" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel">Comprobante de Ingreso <span class="fecha">Fecha: <?=date("d/m/Y")?></span></h4>
			</div>
...
function reiniciaNroRecibo(){
   getNroRecibo('I','BUSCANUMERACION','NRORECIBOINGRESO','<?php echo $Vars ?>','<?=$_GET['TP']?>');
}
