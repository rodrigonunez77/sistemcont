    ...
    <div class="modal-dialog modal-lg" id="ModalCompraSIZE" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="gridSystemModalLabel">Modificar Comprobante de Ingreso <span class="fecha">Fecha: <?=date("d/m/Y")?></span></h4>
            </div>
...
$(document).ready(function(e) {
    ...
    $('#dataUpdate').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-body #DESCRIPCIONU').val(concepto);
