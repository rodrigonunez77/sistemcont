                            ...
                            <div class="col-lg-3">
                                ...
                                <select style="font-size: 13px;" id="TIPOREPORTE" name="TIPOREPORTE" class="form-control" data-validation="required" onchange="getTipoPersona(this.value,'BUSCATIPOPERSONA','TIPOPERSONA','<?php echo $Vars ?>')" >
                                 ...
                                 -->
                                  ...
                                  <option value="NPLA" >NRO PLACA</option>
                                 
                                  
                                </select>
                            </div>
                            <div class="col-lg-1">
                               <span id="LABEL-PERSONA"> PERSONA:</span>
                            </div>
                            <div class="col-lg-2">    
...
<script>
  $(document).ready(function() {
    ...
    function generarReport(){
       ...
       if($("#TIPOREPORTE").val()=='-'){
          divReport.innerHTML ="<iframe id='FRAME' overflow:scroll; width='100%' height='450' src='report.php<?=$Vars?>&FECHAINICIO="+$("#FECHAINICIO").val()+"&FECHAFIN="+$("#FECHAFIN").val()+"&TIPOREPORTE="+$("#TIPOREPORTE").val()+"' frameborder='0' > </iframe>"; 
       }
       else if($("#TIPOPERSONA").val()!=null){
    ...
    function generaPdfReport(){
           ...
           if($("#TIPOREPORTE").val()=='-'){
               ...
               var FormReporte = $('#formulario');
                ...
                var FormReporte = $('#formulario');
                FormReporte.attr("action", 'PdfReport.php'+ '<?php echo $Vars?>&CI='+$("#TIPOPERSONA").val()+"&FECHAINICIO="+$("#FECHAINICIO").val()+"&FECHAFIN="+$("#FECHAFIN").val()+"&TIPOREPORTE="+$("#TIPOREPORTE").val());
                FormReporte.submit();
           }
           else{
               alert("Error! seleccione persona");
