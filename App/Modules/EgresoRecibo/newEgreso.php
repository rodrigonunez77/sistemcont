	...
	<div class="modal-dialog modal-lg" id="ModalCompraSIZE" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel">Recibo de Egreso <span class="fecha"></span></h4>
			</div>
...
function reiniciaNroRecibo(){
    getNroRecibo('S','BUSCANUMERACIONRECIBO','NRORECIBOEGRESO','<?php echo $Vars ?>');
}
