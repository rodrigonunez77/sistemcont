            ...
            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-categoria">
                        ...
                        <th>
                            <?php 
                                if($_GET['TIPOREPORTE']=='PRO'){
                                    echo 'NOMBRE PROPIETARIO';
                                  
                                    $sql="select `liquidacion`.`FECHAREGISTRO`,
                ...
                <tbody>
                    ...
                    foreach ($Data as $key => $value){
                         ...
                         $DataAreaTrabajo=Table::getListQuery("select SUM(detalledescuento.DESCUENTO)AS DESCUENTO from liquidacion,detalledescuento where detalledescuento.IDLIQUIDACION=liquidacion.IDLIQUIDACION and  liquidacion.FECHAREGISTRO='".$value['FECHAREGISTRO']."' and liquidacion.IDUSUARIO=".$value['IDUSUARIO']." and detalledescuento.DESCRIPCION='APORTE PARA TRABAJO' ");
