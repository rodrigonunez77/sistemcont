                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-md-3">
                                            <input type="text" class="form-control mayusculas" placeholder="Lugar" aria-label="Lugar" id="LUGARVIAJE" name="LUGARVIAJE" data-validation="required" value="<?=$Data[0]['LUGARVIAJE']?>" >
                                        </div>
                                        <div class="col-md-4 mb-md-3">
                                        ...
                                        <table class="table" id="TR__">
                                          ...
                                          <tbody id="tr-recaudacion">
                                            ...
                                            <tr>
                                              ...
                                              <td><input type="text"  name="td-localidad-<?=$key+1?>" id="td-localidad-<?=$key+1?>" class="form-control mayusculas" placeholder="Lugar" value="<?=$value['LOCALIDAD']?>" ></td>
                                            ...
                                            <table class="table">
                                              ...
                                              <tbody id="tr-descuento">
                                                ...
                                                <tr >
                                                  ...
                                                  <td><input type="text"  name="td-descripcion-<?=$keyDes+1?>" id="td-descripcion-<?=$keyDes+1?>" class="form-control" placeholder="APORTE PARA TRABAJO" value="<?=$valueDes['DESCRIPCION']?>" readonly></td>
