	   ...
	   //$nombreImagen=$nombreImagen.$_FILES["IMAGEN"]['name'][$key]."@";
		...
		if(isset($_FILES["IMAGEN"]["name"][$key])){
			if($_FILES["IMAGEN"]["name"][$key]!=""){
				...
				$sentencia="insert into imagendepositos set NROINFORME='".$_POST['NROINFORME']."',NOMBRE='DEPLIK".$_POST['NROINFORME'].'_'.$key.'_'.$aletorio."',UBICACION='Depositos', EXTENCION='".$ext."'";
