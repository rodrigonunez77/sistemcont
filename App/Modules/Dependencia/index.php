<?php 
    ...
    */
    ...
    $DataD=DependenciasList::getList();
?>
...
<head>
    ...
    <?php
       include 'newDependencia.php';
       include 'editDependencia.php';
       include 'delDependencia.php';
    ?>
</head>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-dependencia">
                                <thead>
                                    <tr>
                                        <th>Nro</th>
                                        <th>Tipo</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($DataD as $key => $value){
                                        if($value['TIPO']=='U')$tipo='UNIDAD';
                                        elseif($value['TIPO']=='A')$tipo='AREA';
                                        elseif($value['TIPO']=='D')$tipo='DIRECCION';
                                    ?>
                                    <tr>
                                        <td><?=$key+1 ?></td>
                                        <td><?=$tipo?></td>
                                        ...
                                        <td>
                                            <div class="btn-group" style="width: 50px">
                                              <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#dataUpdate"
                                                  ...
                                                  data-sistemas       =   "<?=$value['SISTEMAS']?>">
                                                  <i class='glyphicon glyphicon-edit'></i> Modificar
                                              </button>

                                              <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#dataDelete" data-id="<?=$value['IDDEPENDENCIA']?>"  >
