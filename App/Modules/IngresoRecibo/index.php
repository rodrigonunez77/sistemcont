<?php 
    ...
    */
    ...
    $Data=Table::getListQuery("select * from movimientos where TIPOREGISTRO='I' ".$condicion." and TIPOCONCEPTO='GENERAL' ORDER BY IDMOVIMIENTO DESC");
?>
