                    ...
                    <div  class="container-fluid"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <select style="font-size: 13px;" id="TIPOREPORTE" name="TIPOREPORTE" class="form-control" data-validation="required" >
                            ...
                            <div class="col-lg-2">    
                                OFICINA:&nbsp;<input type="radio" name="TIPOCONCEPTO" id="OFICINA" value="OFICINA" checked>
                            </div>
                            <div class="col-lg-2">  
                                IMPOSITIVO:&nbsp;<input type="radio" name="TIPOCONCEPTO" id="IMPOSITIVO" value="IMPOSITIVO">  
                            </div>
                            <div class="col-lg-2">
                            </div>
                        ...
                        <hr>
                         <div class="row">
                            ...
                            <div class="col-lg-3">
                               FECHA INICIO:    <input id="FECHAINICIO" name="FECHAINICIO" type="date"  class="form-control" data-validation="date" data-validation-format="yyyy-mm-dd" value="<?=date("Y-m-d")?>" />
                            </div>
                            <div class="col-lg-3">
                               FECHA FIN:   <input id="FECHAFIN" name="FECHAFIN" type="date"  class="form-control" data-validation="date" data-validation-format="yyyy-mm-dd" value="<?=date("Y-m-d")?>"/>
                            </div>

                            <div class="col-lg-2" ><br>
                                <button type="button" class="btn btn-primary" onclick="generarReport()" >BUSCAR</button>
                            </div>
                            <div class="col-lg-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3" >
                                <br>
                                <button type="button" class="btn btn-primary" onclick="generaPdfReport()" data-toggle="modal" data-target="">Exportar PDF</button>
                            </div>
  ...
  $(document).ready(function() {
    ...
    function generarReport(){
        ...
        var divReport = document.getElementById("DIV-REPORT");
         ...
         if($("#TIPOREPORTE").val()=='LIBRO DIARIO'){
             divReport.innerHTML ="<iframe id='FRAME' overflow:scroll; width='100%' height='450' src='reportLibroDiario.php<?=$Vars?>&TIPOREPORTE="+$("#TIPOREPORTE").val()+"&TIPOCONCEPTO="+tipoConcept+"&FECHAINICIO="+$("#FECHAINICIO").val()+"&FECHAFIN="+$("#FECHAFIN").val()+"' frameborder='0' > </iframe>";
         }
         else{
             divReport.innerHTML ="<iframe id='FRAME' overflow:scroll; width='100%' height='450' src='report.php<?=$Vars?>&TIPOREPORTE="+$("#TIPOREPORTE").val()+"&TIPOCONCEPTO="+tipoConcept+"&FECHAINICIO="+$("#FECHAINICIO").val()+"&FECHAFIN="+$("#FECHAFIN").val()+"' frameborder='0' > </iframe>";
    ...
    function generaPdfReport(){
       ...
       if($("#TIPOREPORTE").val()=='LIBRO DIARIO'){
             var FormReporte = $('#formulario');
                FormReporte.attr("action", 'PdfLibroDiario.php'+ '<?php echo $Vars?>&FECHAINICIO='+$('#FECHAINICIO').val()+'&FECHAFIN='+$('#FECHAFIN').val()+'&TIPOCONCEPTO='+tipoConcept);
                FormReporte.submit();
        }
        else{
             var FormReporte = $('#formulario');
                FormReporte.attr("action", 'PdfReport.php'+ '<?php echo $Vars?>&FECHAINICIO='+$('#FECHAINICIO').val()+'&FECHAFIN='+$('#FECHAFIN').val()+'&TIPOCONCEPTO='+tipoConcept+'&TIPOREPORTE='+$('#TIPOREPORTE').val());
                FormReporte.submit();
        }
    }
</script>
